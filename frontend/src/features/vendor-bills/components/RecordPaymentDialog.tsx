...
} from "../validators/vendor-bills.validator";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto p-6">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold tracking-tight">Record Bill Payment</DialogTitle>
          <DialogDescription>
            Register outgoing payment sent to the vendor against this bill.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-2 flex flex-col gap-5">
          ...
          <DialogFooter className="mt-2 pt-4 border-t border-border/40 flex flex-row items-center justify-end gap-2">
            ...
            <Button type="submit" disabled={payVendorBill.isPending}>
              {payVendorBill.isPending && <Spinner className="mr-2 size-4" />}
